...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/home/tool', [HomeController::class,'loanTool'])->name('dashboard.loan.tool');
    Route::post('/home/laboratorium', [HomeController::class,'loanLaboratorium'])->name('dashboard.loan.laboratorium');

    Route::get('/profile', [ProfileController::class, 'index'])->name('profile');
    Route::put('/profile', [ProfileController::class, 'update'])->name('profile.update');


    Route::middleware(['admin', 'faculty_admin', 'department_admin'])->group(function () {
